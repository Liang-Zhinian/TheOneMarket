...
export class ItemModel extends BaseModel {
  ...
  async getItemDetials() {
    ...
    console.log('getItemDetials ---> ', res)
  ...
  setItemData(data) {
    // data = DataMap.mapItemData(data)
    // console.log('Item Model setItemData before => ', data);
    // console.log('Item Model setItemData before => ', this);
    Object.keys(data).map(key => {
      this[key] = data[key]
    })
    
    // this.images = DataMap.mapImagesData(this.images)
    DataMap.mapItemData(this, data)
    console.log('Item Model setItemData after => ', this);
